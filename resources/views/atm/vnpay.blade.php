...
<div class="container">
    ...
    <div class="table-responsive">
        <form action="{{ route(CREATE_PAYMENT_VNPAY) }}" id="create_form" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="txtexpire"
                       name="txtexpire" type="text" value="{{ date('YmdHis',strtotime('+15 minutes',strtotime(date("YmdHis")))) }}"/>
            </div>
            <div class="form-group">
