                    ...
                    success: function (e) {
                        if (e.status == 1) {
                            ...
                            let html = '<tr>'+
                                ...
                                '<td>'+
                                '<a href="http://100.93.254.15:31009/admin/product/color/'+e.data.id+'" class="btn btn-primary">Thay đổi</a>'+
                                '<a href="http://100.93.254.15:31009/admin/product/color/'+e.data.id+'/delete" class="btn btn-danger">Xoá</a>'+
                                '</td>'+
                                '</tr>'
